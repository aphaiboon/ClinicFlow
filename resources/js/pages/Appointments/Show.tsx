...
import {
    assignRoom as assignRoomRoute,
    cancel as cancelRoute,
    edit,
    index,
} from '@/routes/appointments';
import { type Appointment, type BreadcrumbItem, type ExamRoom } from '@/types';
import { Form, Head, Link } from '@inertiajs/react';
import { Calendar, Clock, MapPin, Pencil, User, X } from 'lucide-react';
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs(appointment)}>
            ...
            <div className="space-y-6">
                ...
                <Dialog
                    open={showAssignRoomDialog}
                    onOpenChange={setShowAssignRoomDialog}
                >
                    <DialogContent>
