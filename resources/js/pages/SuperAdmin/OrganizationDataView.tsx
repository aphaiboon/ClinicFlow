...
import { Building, Users, FileText, Calendar, Activity } from 'lucide-react';
            ...
            <div className="space-y-6">
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        {organization.email && (
                            <p className="text-muted-foreground mt-2">{organization.email}</p>
                        )}
                    </div>
                ...
                <div className="grid gap-4 md:grid-cols-4">
                    ...
                    <Card>
                        ...
                        <CardContent>
                            <div className="text-2xl font-bold">{stats.examRoomsCount}</div>
                        </CardContent>
                    </Card>
                ...
                {organization.address_line_1 && (
                    <Card>
                        ...
                        <CardContent>
                            ...
                            {organization.phone && <p className="mt-2">{organization.phone}</p>}
                        </CardContent>
                    </Card>
                )}
                            ...
                            <div className="space-y-2">
                                {organization.members.map((member) => (
                                    <div key={member.id} className="flex items-center justify-between">
                                        ...
                                        <Badge variant="outline">{member.pivot.role}</Badge>
                                    </div>
                                ))}
                            </div>
                        </CardContent>
