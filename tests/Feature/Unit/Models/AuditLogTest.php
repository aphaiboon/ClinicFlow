...
it('casts action to enum', function () {
    $auditLog = AuditLog::factory()->for($this->organization)->create(['action' => AuditAction::Create]);
...
it('casts changes to array', function () {
    ...
    $auditLog = AuditLog::factory()->for($this->organization)->create(['changes' => $changes]);
...
it('casts metadata to array', function () {
    ...
    $auditLog = AuditLog::factory()->for($this->organization)->create(['metadata' => $metadata]);
...
it('can scope by user', function () {
    $user = User::factory()->create();
    AuditLog::factory()->for($this->organization)->count(2)->create(['user_id' => $user->id]);
    AuditLog::factory()->for($this->organization)->create();
...
it('can scope by resource', function () {
    AuditLog::factory()->for($this->organization)->create(['resource_type' => 'Patient', 'resource_id' => 1]);
    AuditLog::factory()->for($this->organization)->create(['resource_type' => 'Patient', 'resource_id' => 2]);
    AuditLog::factory()->for($this->organization)->create(['resource_type' => 'Appointment', 'resource_id' => 1]);
...
it('can scope by action', function () {
    AuditLog::factory()->for($this->organization)->count(2)->create(['action' => AuditAction::Create]);
    AuditLog::factory()->for($this->organization)->create(['action' => AuditAction::Update]);
...
it('can scope by date range', function () {
    ...
    AuditLog::factory()->for($this->organization)->create(['created_at' => $start->copy()->subDays(5)]);
    AuditLog::factory()->for($this->organization)->create(['created_at' => $start->copy()->addDays(2)]);
    AuditLog::factory()->for($this->organization)->create(['created_at' => $end->copy()->addDays(5)]);
